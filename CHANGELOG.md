# Changelog for the Encrypt package
...
- Fix parts directives to use URI's to fix dart analyze errors, change to using !.isEmpty rather than !.length<1
- Fix spelling errors in comments/docs
- Fix CHANGELOG.md to only have one top level #
